...
export class CodepushProvider {
  ...
  constructor(
    ...
    console.log('Hello CodepushProvider Provider', this.cp);
  }
  ...
  public checkCodePush() {
    ...
    this.cp.sync({ installMode: InstallMode.IMMEDIATE, updateDialog: {
      ...
      mandatoryContinueButtonLabel: `Go On`,
      ...
      updateTitle: `New Update Available`,
        ...
        prog = progress;
        this.global.cLog(`Progress i,s`, prog);
        ...
        if (status == SyncStatus.IN_PROGRESS) {
            this.global.cLog(`Status is in progress`);
        }
